...
#drug=pygame.image.load(drug_file)
#screen.blit(drug, [x, y])
#vrag_file="shar.PNG"
#vrag=pygame.image.load(vrag_file)
...
drug1_file="racet.PNG"
drug2_file="racet 2.PNG"

drug1=pygame.image.load(drug1_file)
drug2=pygame.image.load(drug2_file)
...
yd = 364
dom_file="dom.PNG"
dom=pygame.image.load(dom_file)
...
while running:
    ...
    #pygame.draw.rect(screen, THECOLORS['brown'], [xr, yr, width, heigth], 0)
    #pygame.draw.rect(screen1, THECOLORS['red'], [xr1, yr1, width1, heigth1], 0)
    screen.blit(drug1, [xr, yr])
    screen.blit(drug2, [xr1, yr1])

    for i in range(0,12):
        screen.blit(dom, [10+i*100,yd])
    #pygame.draw.circle(screen, THECOLORS['red'], [x, y], r, 0)
    screen.blit(vrag, [x, y])
